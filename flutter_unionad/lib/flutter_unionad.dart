...
class FlutterUnionad {
  static UnionadPlatform get _platform => UnionadPlatform.instance;
  ...
  static Future<void> requestPermissionIfNecessary(
    ...
    switch (await _platform.requestPermissionIfNecessary()) {
      //未确定
  ...
  static Future<String> getSDKVersion() async {
    return await _platform.getSDKVersion();
  }
  ...
  static Future<bool> showRewardVideoAd() async {
    return await _platform.showRewardVideoAd();
  }
  ...
  static Future<bool> showFullScreenVideoAdInteraction() async {
    return await _platform.showFullScreenVideoAdInteraction();
  }

  /// 获取主题模式 0正常模式 1夜间模式
  static Future<int> getThemeStatus() async {
    return await _platform.getThemeStatus();
  }
}
