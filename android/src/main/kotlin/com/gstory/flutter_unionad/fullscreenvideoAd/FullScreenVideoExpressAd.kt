            ...
            override fun onFullScreenVideoAdLoad(ad: TTFullScreenVideoAd) {
                ...
                mttFullVideoAd!!.setFullScreenVideoAdInteractionListener(object : TTFullScreenVideoAd.FullScreenVideoAdInteractionListener {
                    override fun onAdShow() {
                        ...
                        var map = mutableMapOf("adType" to "fullVideoAd","fullVideoType" to "onAdShow")
                        FlutterUnionadEventPlugin.sendContent(map)
                    }

                    override fun onAdVideoBarClick() {
                        Log.e(TAG,"fullScreenVideoAd click")
                        var map = mutableMapOf("adType" to "fullVideoAd","fullVideoType" to "onAdVideoBarClick")
                        FlutterUnionadEventPlugin.sendContent(map)
                    }

                    override fun onAdClose() {
                        Log.e(TAG,"fullScreenVideoAd close")
                        var map = mutableMapOf("adType" to "fullVideoAd","fullVideoType" to "onAdClose")
                        FlutterUnionadEventPlugin.sendContent(map)
                    }

                    override fun onVideoComplete() {
                        Log.e(TAG,"fullScreenVideoAd complete")
                        var map = mutableMapOf("adType" to "fullVideoAd","fullVideoType" to "onVideoComplete")
                        FlutterUnionadEventPlugin.sendContent(map)
                    }

                    override fun onSkippedVideo() {
                        Log.e(TAG,"fullScreenVideoAd skipped")
                        var map = mutableMapOf("adType" to "fullVideoAd","fullVideoType" to "onSkippedVideo")
                        FlutterUnionadEventPlugin.sendContent(map)
                    }
                })
